...
public class GeneratePdf {
    ...
    public static ByteArrayInputStream usersInfoPdf(Users users, Companies com) {
        ...
        try {
            ...
            if(! users.getWorkExperience().isEmpty()) {
...
*/
            ...
            if(!users.getEducations().isEmpty()) {
